...
public class sllMain {
    ...
    public static void main(String[] args) {
        ...
        // Source code untuk tugas no 2

        System.out.println("");
        System.out.println("======= Jawaban tugas no 2 ========");
        System.out.println("");
        ...
        // Source code untuk tugas no 3

        System.out.println("");
        System.out.println("======= Jawaban tugas no 3 ========");
        System.out.println("");
        ...
        // Source code untuk tugas no 4

        System.out.println("");
        System.out.println("======= Jawaban tugas no 4 ========");
        System.out.println("");

        int pilih;
        do {
            menu();
            System.out.print("Masukkan menu yang anda pilih (sesuai angka ya :V) : ");
            pilih = sc.nextInt();
            switch (pilih) {
                case 1:
